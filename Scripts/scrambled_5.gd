...
var scrambled_letters = ["C", "O", "N", "F", "I", "D", "E", "N", "T", "I", "A", "L", "I", "T", "Y"]
var correct_word = "CONFIDENTIALITY"
var selected_word = ""
...
func _ready():
	...
	button_14 = $HBoxContainer/Button14
	button_15 = $HBoxContainer/Button15
	
	submit_button = $SubmitButton
	output_label = $OutputLabel

	# Ensure all buttons exist and are properly assigned
	var buttons = [button_1, button_2, button_3, button_4, button_5, button_6, button_7
...
func _on_SubmitButton_pressed():
	if selected_word == correct_word:
		...
		get_tree().change_scene_to_file("res://Scenes/scrambledscene/scrambled6.tscn")
	else:
