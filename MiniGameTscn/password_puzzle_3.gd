...
func _on_submit_pressed() -> void:
	...
	if input_password.length() >= 14 and has_upper and has_number:
		...
		if input_password.length() < 14:
			password_input.placeholder_text = "Password must be at least 14 characters."
		elif not has_upper:
			password_input.placeholder_text = "Add at least 1 capital letter."
		elif not has_number:
			password_input.placeholder_text = "Include at least 1 number."
		else:
